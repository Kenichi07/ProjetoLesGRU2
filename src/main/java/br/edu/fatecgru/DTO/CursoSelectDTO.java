...
public class CursoSelectDTO {
    ...
    private boolean favoritadoPorUsuario;
  	...
  	public CursoSelectDTO() {}
	public CursoSelectDTO(Curso c) {
        id = c.getId();
        nome = c.getNome();
	...
	public CursoSelectDTO(int id, String nome, String descricao, String linkCurso, String nomeCategoria) {
        this.id = id;
        this.nome = nome;
	...
	public CursoSelectDTO(Integer id, String nome, String descricao, String linkCurso, String nomeCategoria,
			boolean favoritadoPorUsuario) {
		super();
		this.id = id;
		this.nome = nome;
		this.descricao = descricao;
		this.linkCurso = linkCurso;
		this.nomeCategoria = nomeCategoria;
		this.favoritadoPorUsuario = favoritadoPorUsuario;
	}
	
	public CursoCadastroDTO toCursoCadastroDTO1() {
